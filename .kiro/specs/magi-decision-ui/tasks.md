...
- [x] 2. データモデルとAmplify Data設定の作成
  ...
  - [ ] 2.3 実際のAmplify Dataデプロイと統合準備 **[👤 Human + 🤖 Kiro]**
...
- [ ] 10. 実際のAmplify Data統合とリアルタイム機能 **[🤖 Kiro + 👤 Human]**
  - [ ] 10.1 Amplify Data実環境への切り替え **[🤖 Kiro + 👤 Human]**
    - **[👤 Human]** AWS環境でのAmplify Dataデプロイ実行
    - **[🤖 Kiro]** モッククライアントから実クライアントへの切り替え
    - **[🤖 Kiro]** 環境変数による開発/本番環境の自動切り替え
    - **[🤖 Kiro]** データシーディング機能による初期データ投入
    - _要件: 2.1, 2.2, 2.3_
